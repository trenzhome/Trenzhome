...
export function Hero({
  ...
  return (
    <section className="relative -mt-[116px] md:-mt-[164px] min-h-[92vh] pt-[116px] md:pt-[164px] bg-ink text-paper overflow-hidden flex items-center">
      ...
      <motion.div
        className="absolute inset-y-0 right-0 hidden md:block w-[45%] lg:w-[42%]"
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 w-full">
        ...
        <div className="mt-12 flex gap-3 overflow-x-auto pb-2 md:hidden -mx-6 px-6 snap-x snap-mandatory">
          {[main, side1, side2, side3]
            ...
            .map((p, i) => (
              <motion.div
                ...
                className="relative h-40 w-32 flex-none snap-start"
              >
                <Link
                  href={`/product/${p.slug}`}
