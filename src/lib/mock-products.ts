...
// Fallback catalog used only when SHOPIFY_STORE_DOMAIN /
// SHOPIFY_STOREFRONT_ACCESS_TOKEN aren't configured, so the site still runs
// end-to-end (e.g. local dev without secrets) instead of breaking outright.
